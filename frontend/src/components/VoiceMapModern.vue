<template>
  <div class="voice-map-modern">
    <!-- Carte Mapbox moderne -->
    <div id="modern-map" class="map-container"></div>
...
import { MAPBOX_CONFIG, initMapbox, getTimeBasedStyle } from '../config/mapbox.js'
...
onMounted(async () => {
  ...
  map.value = new mapboxgl.Map({
    container: 'modern-map',
    style: getTimeBasedStyle(), // Style adaptatif jour/nuit
  ...
  map.value.on('load', () => {
    showStatusMessage('Carte chargée', '🗺️', 'success')
